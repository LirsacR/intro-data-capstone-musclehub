...
#Here we have categorical data and we will use a chi square testing as we have 2 categories with 2 possible values
from scipy.stats import chi2_contingency
X = [[250, 2254], [325, 2175]]
chi2_contingency(X)

#h0: no significant differences between DS
#p-value is 0.00096... which is <0.05
#h0 is rejected
#our test tells us that there is a significant difference between the 2 DS
...
chi2_contingency(Y)
#h0: no significant differences between DS
#p-value is 0.4... which is >0.05
#h0 is accepted
#our test tells us that there is no significant difference between the 2 DS
...
#h0: no significant differences between DS
#p-value is 0.014... which is <0.05
#h0 is rejected
#our test tells us that there is a significant difference between the 2 DS
